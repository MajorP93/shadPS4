...
void OnGameLoaded() {
    ...
    if (g_game_serial == "CUSA03173" || g_game_serial == "CUSA00900" || g_game_serial == "CUSA00299" || g_game_serial == "CUSA00207" || g_game_serial == "CUSA03023") {
        std::filesystem::path savedir = Common::FS::GetUserPath(Common::FS::PathType::SaveDataDir) / "1" / g_game_serial / "SPRJ0005";
